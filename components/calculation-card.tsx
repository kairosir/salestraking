  ...
  return (
    <>
      <button
        ...
        className="flex h-[74px] w-full flex-col rounded-2xl border border-line bg-card/70 bg-panel p-2.5 text-left transition hover:border-accent sm:h-28 sm:p-3.5"
      >
