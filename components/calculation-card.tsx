  ...
  return (
    <>
      <button
        ...
        className="flex h-24 w-full flex-col justify-between rounded-2xl border border-line bg-card/70 p-3 text-left transition hover:border-accent sm:h-28 sm:p-3.5"
      >
